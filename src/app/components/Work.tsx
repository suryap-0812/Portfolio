...
const PROJECTS = [
  {
    title: 'TribeTask',
    sub: 'February 2026',
    desc: 'A real-time collaborative task management platform enabling users to form "Tribes" and manage shared tasks efficiently. Scalable backend for secure group management.',
  ...
  },
  {
    ...
    sub: 'April 2026',
    desc: 'A mobile application that enables automated form parsing, regional language translation, and interactive voice assistant guidance for simplified multi-lingual explanations.',
  ...
  },
  {
    ...
    sub: 'December 2025',
    desc: 'A full-stack web application to track and compare product prices across multiple vendors. Implemented structured data modeling and persistent storage to analyze trends.',
