...
const PALETTE: Record<Section, string[]> = {
    hero: ['rgba(56, 189, 248,', 'rgba(59, 130, 246,', 'rgba(251,191,36,', 'rgba(180,100,70,'],
    about: ['rgba(56, 189, 248,', 'rgba(253,230,138,', 'rgba(180,100,70,'],
    work: ['rgba(59, 130, 246,', 'rgba(56, 189, 248,', 'rgba(251,191,36,'],
    contact: ['rgba(56, 189, 248,', 'rgba(59, 130, 246,', 'rgba(253,230,138,'],
};
...
export default function ParticleCanvas({ section }: { section: Section }) {
    ...
    useEffect(() => {
        ...
        const draw = () => {
            ...
            if (section === 'hero') {
                [
                    { x: W * 0.15, y: H * 0.25, r: W * 0.30, c: 'rgba(56, 189, 248,0.05)' },
                    { x: W * 0.80, y: H * 0.60, r: W * 0.22, c: 'rgba(59, 130, 246,0.045)' },
            ...
            if (section === 'work') {
                ...
                [
                    ...
                    grd.addColorStop(0.6, 'rgba(59, 130, 246,0.04)');
            ...
            if (section === 'contact') {
                ...
                for (let i = 0; i < 28; i++) {
                    ...
                    g.addColorStop(0.5, `rgba(56, 189, 248,${a})`);
                    g.addColorStop(1, `rgba(59, 130, 246,${a * 0.7})`);
